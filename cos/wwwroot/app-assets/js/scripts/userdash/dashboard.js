...
function GetInventory() {
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            $('#info-box-total').html(data.total_kyc);
            $('#info-box-completed').html(data.comp_kyc);
            $('#info-box-pending').html(data.pend_kyc);
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            for (var i = 0; i < data.length; i++) {
                ...
                tableString += '<td>' + data[i].total_kyc + '</td>';
                tableString += '<td>' + data[i].comp_kyc + '</td>';
                tableString += '<td>' + data[i].pend_kyc + '</td>';
                tableString += '</tr>';
            }
